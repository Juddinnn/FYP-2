...
ABLATION_CONFIGS = {
    ...
    "No TTL Features": [
        f for f in ALL_FEATURES if f not in TTL_FEATURES
    ],

    "No IP Diversity Features": [
        f for f in ALL_FEATURES if f not in IP_DIVERSITY_FEATURES
    ],

    "No DNS Structure Features": [
        f for f in ALL_FEATURES if f not in DNS_STRUCTURE_FEATURES
    ]
}
